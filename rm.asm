...
free(void *ap)
{
 ...
 5d1:	a1 40 0a 00 00       	mov    0xa40,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 64a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 64d:	a3 40 0a 00 00       	mov    %eax,0xa40
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 40 0a 00 00    	mov    0xa40,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 70c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 70f:	89 15 40 0a 00 00    	mov    %edx,0xa40
      return (void*)(p + 1);
 ...
 724:	eb e9                	jmp    70f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 726:	c7 05 40 0a 00 00 44 	movl   $0xa44,0xa40
 72d:	0a 00 00 
 730:	c7 05 44 0a 00 00 44 	movl   $0xa44,0xa44
 737:	0a 00 00 
    base.s.size = 0;
 73a:	b8 44 0a 00 00       	mov    $0xa44,%eax
 73f:	c7 05 48 0a 00 00 00 	movl   $0x0,0xa48
 746:	00 00 00 
