...
main(int argc, char *argv[])
{
  ...
  65:	68 43 07 00 00       	push   $0x743
  6a:	6a 02                	push   $0x2
  6c:	e8 9f 03 00 00       	call   410 <printf>
...
free(void *ap)
{
 ...
 5b1:	a1 0c 0a 00 00       	mov    0xa0c,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 607:	89 08                	mov    %ecx,(%eax)
  freep = p;
 609:	a3 0c 0a 00 00       	mov    %eax,0xa0c
}
 60e:	5b                   	pop    %ebx
 60f:	5e                   	pop    %esi
 610:	5f                   	pop    %edi
 ...
 62a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 62d:	a3 0c 0a 00 00       	mov    %eax,0xa0c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 15 0c 0a 00 00    	mov    0xa0c,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6ec:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6ef:	89 15 0c 0a 00 00    	mov    %edx,0xa0c
      return (void*)(p + 1);
 ...
 704:	eb e9                	jmp    6ef <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 706:	c7 05 0c 0a 00 00 10 	movl   $0xa10,0xa0c
 70d:	0a 00 00 
 710:	c7 05 10 0a 00 00 10 	movl   $0xa10,0xa10
 717:	0a 00 00 
    base.s.size = 0;
 71a:	b8 10 0a 00 00       	mov    $0xa10,%eax
 71f:	c7 05 14 0a 00 00 00 	movl   $0x0,0xa14
 726:	00 00 00 
