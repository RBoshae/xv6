...
main(int argc, char *argv[])
{
  ...
  68:	68 33 08 00 00       	push   $0x833
  6d:	6a 01                	push   $0x1
  6f:	e8 7c 04 00 00       	call   4f0 <printf>
      exit(0);
