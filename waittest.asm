...
free(void *ap)
{
 ...
 541:	a1 5c 09 00 00       	mov    0x95c,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 597:	89 08                	mov    %ecx,(%eax)
  freep = p;
 599:	a3 5c 09 00 00       	mov    %eax,0x95c
}
 59e:	5b                   	pop    %ebx
 59f:	5e                   	pop    %esi
 5a0:	5f                   	pop    %edi
 ...
 5ba:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 5bd:	a3 5c 09 00 00       	mov    %eax,0x95c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 5d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 5dc:	8b 15 5c 09 00 00    	mov    0x95c,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 62f:	76 3f                	jbe    670 <malloc+0xa0>
    ...
    if(p == freep)
 631:	39 05 5c 09 00 00    	cmp    %eax,0x95c
 ...
 656:	e8 e5 fe ff ff       	call   540 <free>
  return freep;
 65b:	8b 15 5c 09 00 00    	mov    0x95c,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 67c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 67f:	89 15 5c 09 00 00    	mov    %edx,0x95c
      return (void*)(p + 1);
 ...
 694:	eb e9                	jmp    67f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 696:	c7 05 5c 09 00 00 60 	movl   $0x960,0x95c
 69d:	09 00 00 
 6a0:	c7 05 60 09 00 00 60 	movl   $0x960,0x960
 6a7:	09 00 00 
    base.s.size = 0;
 6aa:	b8 60 09 00 00       	mov    $0x960,%eax
 6af:	c7 05 64 09 00 00 00 	movl   $0x0,0x964
 6b6:	00 00 00 
