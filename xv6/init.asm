...
main(void)
{
  ...
  13:	6a 02                	push   $0x2
  15:	68 c0 07 00 00       	push   $0x7c0
  1a:	e8 73 03 00 00       	call   392 <open>
  1f:	83 c4 10             	add    $0x10,%esp
  22:	85 c0                	test   %eax,%eax
  24:	0f 88 b3 00 00 00    	js     dd <main+0xdd>
    mknod("console", 1, 1);
    open("console", O_RDWR);
  }
  dup(0);  // stdout
  2a:	83 ec 0c             	sub    $0xc,%esp
  2d:	8d 75 e4             	lea    -0x1c(%ebp),%esi
  30:	6a 00                	push   $0x0
  32:	e8 93 03 00 00       	call   3ca <dup>
  dup(0);  // stderr
  ...
  5a:	e8 41 04 00 00       	call   4a0 <printf>
    pid = fork();
  5f:	e8 e6 02 00 00       	call   34a <fork>
    if(pid < 0){
  ...
  69:	89 c3                	mov    %eax,%ebx
    if(pid < 0){
  6b:	78 2b                	js     98 <main+0x98>
      printf(1, "init: fork failed\n");
      exit(0);
    }
    if(pid == 0){
  6d:	74 43                	je     b2 <main+0xb2>
  6f:	90                   	nop
      exec("sh", argv);
  ...
  98:	53                   	push   %ebx
  99:	53                   	push   %ebx
  9a:	68 db 07 00 00       	push   $0x7db
  9f:	6a 01                	push   $0x1
  a1:	e8 fa 03 00 00       	call   4a0 <printf>
      exit(0);
  a6:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  ad:	e8 a0 02 00 00       	call   352 <exit>
    }
    if(pid == 0){
      exec("sh", argv);
  b2:	50                   	push   %eax
  b3:	50                   	push   %eax
  b4:	68 b8 0a 00 00       	push   $0xab8
  b9:	68 ee 07 00 00       	push   $0x7ee
  be:	e8 c7 02 00 00       	call   38a <exec>
      printf(1, "init: exec sh failed\n");
  c3:	5a                   	pop    %edx
  c4:	59                   	pop    %ecx
  c5:	68 f1 07 00 00       	push   $0x7f1
  ca:	6a 01                	push   $0x1
  cc:	e8 cf 03 00 00       	call   4a0 <printf>
      exit(0);
  d1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  d8:	e8 75 02 00 00       	call   352 <exit>
{
  int pid, wpid;
  int status;                                         // Lab 1 Part 1b -RB 
  ...
  de:	6a 01                	push   $0x1
  e0:	6a 01                	push   $0x1
  e2:	68 c0 07 00 00       	push   $0x7c0
  e7:	e8 ae 02 00 00       	call   39a <mknod>
    open("console", O_RDWR);
  ec:	58                   	pop    %eax
  ed:	5a                   	pop    %edx
  ee:	6a 02                	push   $0x2
  f0:	68 c0 07 00 00       	push   $0x7c0
  f5:	e8 98 02 00 00       	call   392 <open>
  fa:	83 c4 10             	add    $0x10,%esp
  fd:	e9 28 ff ff ff       	jmp    2a <main+0x2a>
...
free(void *ap)
{
 ...
 697:	89 08                	mov    %ecx,(%eax)
  freep = p;
 699:	a3 c0 0a 00 00       	mov    %eax,0xac0
}
 69e:	5b                   	pop    %ebx
 69f:	5e                   	pop    %esi
 6a0:	5f                   	pop    %edi
 ...
 6ba:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6bd:	a3 c0 0a 00 00       	mov    %eax,0xac0
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 77c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 77f:	89 15 c0 0a 00 00    	mov    %edx,0xac0
      return (void*)(p + 1);
 ...
 794:	eb e9                	jmp    77f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 796:	c7 05 c0 0a 00 00 c4 	movl   $0xac4,0xac0
 79d:	0a 00 00 
 7a0:	c7 05 c4 0a 00 00 c4 	movl   $0xac4,0xac4
 7a7:	0a 00 00 
    base.s.size = 0;
 7aa:	b8 c4 0a 00 00       	mov    $0xac4,%eax
 7af:	c7 05 c8 0a 00 00 00 	movl   $0x0,0xac8
 7b6:	00 00 00 
