...
exitiputtest(void)
{
  ...
  printf(stdout, "exitiput test ok\n");
     2bc:	58                   	pop    %eax
     2bd:	5a                   	pop    %edx
     2be:	68 5e 43 00 00       	push   $0x435e
     2c3:	ff 35 84 63 00 00    	pushl  0x6384
     2c9:	e8 f2 3c 00 00       	call   3fc0 <printf>
}
...
openiputtest(void)
{
  ...
  printf(stdout, "openiput test ok\n");
     401:	58                   	pop    %eax
     402:	5a                   	pop    %edx
     403:	68 a8 43 00 00       	push   $0x43a8
     408:	ff 35 84 63 00 00    	pushl  0x6384
     40e:	e8 ad 3b 00 00       	call   3fc0 <printf>
}
...
pipe1(void)
{
  ...
  printf(1, "pipe1 ok\n");
     c74:	58                   	pop    %eax
     c75:	5a                   	pop    %edx
     c76:	68 5b 46 00 00       	push   $0x465b
     c7b:	6a 01                	push   $0x1
     c7d:	e8 3e 33 00 00       	call   3fc0 <printf>
    ...
    if(total != 5 * 1033){
     ...
     c90:	68 44 46 00 00       	push   $0x4644
     c95:	6a 01                	push   $0x1
     c97:	e8 24 33 00 00       	call   3fc0 <printf>
      exit(0);
  ...
  if(pipe(fds) != 0){
    printf(1, "pipe() failed\n");
     ...
     cab:	68 19 46 00 00       	push   $0x4619
     cb0:	6a 01                	push   $0x1
     cb2:	e8 09 33 00 00       	call   3fc0 <printf>
    exit(0);
    ...
    printf(1, "fork() failed\n");
     ...
     cc6:	68 65 46 00 00       	push   $0x4665
     ccb:	6a 01                	push   $0x1
     ccd:	e8 ee 32 00 00       	call   3fc0 <printf>
    exit(0);
    ...
    for(n = 0; n < 5; n++){
     ...
     ce1:	68 28 46 00 00       	push   $0x4628
     ce6:	6a 01                	push   $0x1
     ce8:	e8 d3 32 00 00       	call   3fc0 <printf>
        exit(0);
...
preempt(void)
{
  ...
  kill(pid3);
  printf(1, "wait... ");
     e0b:	68 ae 46 00 00       	push   $0x46ae
     e10:	6a 01                	push   $0x1
     e12:	e8 a9 31 00 00       	call   3fc0 <printf>
  wait(&status);
  ...
  printf(1, "preempt ok\n");
     e2f:	5e                   	pop    %esi
     e30:	5f                   	pop    %edi
     e31:	68 b7 46 00 00       	push   $0x46b7
     e36:	6a 01                	push   $0x1
     e38:	e8 83 31 00 00       	call   3fc0 <printf>
     ...
     e84:	85 c0                	test   %eax,%eax
{
  ...
  for(i = 0; i < 100; i++){
    ...
    if(pid < 0){
     ...
     e8d:	68 21 52 00 00       	push   $0x5221
     e92:	6a 01                	push   $0x1
     e94:	e8 27 31 00 00       	call   3fc0 <printf>
      return;
  ...
  printf(1, "exitwait ok\n");
    ...
    if(pid){
     ...
     eab:	68 c3 46 00 00       	push   $0x46c3
     eb0:	6a 01                	push   $0x1
     eb2:	e8 09 31 00 00       	call   3fc0 <printf>
        return;
  ...
  printf(1, "exitwait ok\n");
     ...
     ecb:	68 d3 46 00 00       	push   $0x46d3
     ed0:	6a 01                	push   $0x1
     ed2:	e8 e9 30 00 00       	call   3fc0 <printf>
...
mem(void)
{
  ...
  if((pid = fork()) == 0){
    ...
    if(m1 == 0){
     ...
     fb3:	68 ea 46 00 00       	push   $0x46ea
     fb8:	6a 01                	push   $0x1
     fba:	e8 01 30 00 00       	call   3fc0 <printf>
      kill(ppid);
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
     fe9:	68 0c 47 00 00       	push   $0x470c
     fee:	6a 01                	push   $0x1
     ff0:	e8 cb 2f 00 00       	call   3fc0 <printf>

  unlink("sharedfd");
     ff5:	c7 04 24 1b 47 00 00 	movl   $0x471b,(%esp)
     ffc:	e8 c1 2e 00 00       	call   3ec2 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    1001:	5b                   	pop    %ebx
    1002:	5e                   	pop    %esi
    1003:	68 02 02 00 00       	push   $0x202
    1008:	68 1b 47 00 00       	push   $0x471b
  ...
  for(i = 0; i < 1000; i++){
    ...
    106c:	68 0c 54 00 00       	push   $0x540c
    1071:	6a 01                	push   $0x1
    1073:	e8 48 2f 00 00       	call   3fc0 <printf>
      break;
  ...
  fd = open("sharedfd", 0);
    ...
    10a0:	5a                   	pop    %edx
    10a1:	6a 00                	push   $0x0
    10a3:	68 1b 47 00 00       	push   $0x471b
  ...
  unlink("sharedfd");
    110a:	c7 04 24 1b 47 00 00 	movl   $0x471b,(%esp)
  ...
  if(nc == 10000 && np == 10000){
    ...
    112f:	68 24 47 00 00       	push   $0x4724
    1134:	6a 01                	push   $0x1
    1136:	e8 85 2e 00 00       	call   3fc0 <printf>
  ...
  if(fd < 0){
    ...
    1149:	68 e0 53 00 00       	push   $0x53e0
    114e:	6a 01                	push   $0x1
    1150:	e8 6b 2e 00 00       	call   3fc0 <printf>
    return;
  ...
  if(fd < 0){
    ...
    1163:	68 2c 54 00 00       	push   $0x542c
    1168:	6a 01                	push   $0x1
    116a:	e8 51 2e 00 00       	call   3fc0 <printf>
    return;
  ...
  if(nc == 10000 && np == 10000){
    ...
    1184:	53                   	push   %ebx
    1185:	52                   	push   %edx
    1186:	68 31 47 00 00       	push   $0x4731
    118b:	6a 01                	push   $0x1
    118d:	e8 2e 2e 00 00       	call   3fc0 <printf>
    exit(0);
...
fourfiles(void)
{
  ...
  printf(1, "fourfiles test\n");
    11a6:	be 46 47 00 00       	mov    $0x4746,%esi
...
fourfiles(void)
{
  ...
  int fd, pid, i, j, n, total, pi;
  char *names[] = { "f0", "f1", "f2", "f3" };
    11b0:	c7 45 d8 46 47 00 00 	movl   $0x4746,-0x28(%ebp)
    11b7:	c7 45 dc 8f 48 00 00 	movl   $0x488f,-0x24(%ebp)
  char *fname;
  int status;     // Lab 1 Part 1b. -RB

  printf(1, "fourfiles test\n");
    11be:	68 4c 47 00 00       	push   $0x474c
    11c3:	6a 01                	push   $0x1
// time, to test block allocation.
void
fourfiles(void)
{
  int fd, pid, i, j, n, total, pi;
  char *names[] = { "f0", "f1", "f2", "f3" };
    11c5:	c7 45 e0 93 48 00 00 	movl   $0x4893,-0x20(%ebp)
    11cc:	c7 45 e4 49 47 00 00 	movl   $0x4749,-0x1c(%ebp)
  char *fname;
  int status;     // Lab 1 Part 1b. -RB

  printf(1, "fourfiles test\n");
    11d3:	e8 e8 2d 00 00       	call   3fc0 <printf>
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    1234:	c7 45 c4 46 47 00 00 	movl   $0x4746,-0x3c(%ebp)
  }
...
createdelete(void)
{
  ...
  printf(1, "createdelete ok\n");
    ...
    14ec:	68 ab 47 00 00       	push   $0x47ab
    14f1:	6a 01                	push   $0x1
    14f3:	e8 c8 2a 00 00       	call   3fc0 <printf>
}
    ...
    1578:	68 99 43 00 00       	push   $0x4399
    157d:	6a 01                	push   $0x1
    157f:	e8 3c 2a 00 00       	call   3fc0 <printf>
            exit(0);
    ...
    159d:	57                   	push   %edi
    159e:	68 58 54 00 00       	push   $0x5458
    15a3:	6a 01                	push   $0x1
    15a5:	e8 16 2a 00 00       	call   3fc0 <printf>
        exit(0);
    ...
    15b9:	68 e7 49 00 00       	push   $0x49e7
    15be:	6a 01                	push   $0x1
    15c0:	e8 fb 29 00 00       	call   3fc0 <printf>
          exit(0);
  ...
  for(pi = 0; pi < 4; pi++){
    ...
    15d4:	68 21 52 00 00       	push   $0x5221
    15d9:	6a 01                	push   $0x1
    15db:	e8 e0 29 00 00       	call   3fc0 <printf>
      exit(0);
    ...
    15f7:	57                   	push   %edi
    15f8:	68 7c 54 00 00       	push   $0x547c
    15fd:	6a 01                	push   $0x1
    15ff:	e8 bc 29 00 00       	call   3fc0 <printf>
        exit(0);
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    ...
    1618:	68 bc 47 00 00       	push   $0x47bc
    161d:	6a 01                	push   $0x1
    161f:	e8 9c 29 00 00       	call   3fc0 <printf>
  fd = open("unlinkread", O_CREATE | O_RDWR);
    1624:	5b                   	pop    %ebx
    1625:	5e                   	pop    %esi
    1626:	68 02 02 00 00       	push   $0x202
    162b:	68 cd 47 00 00       	push   $0x47cd
  ...
  write(fd, "hello", 5);
    ...
    1645:	6a 05                	push   $0x5
    1647:	68 f2 47 00 00       	push   $0x47f2
    164c:	50                   	push   %eax
  ...
  fd = open("unlinkread", O_RDWR);
    ...
    165b:	5a                   	pop    %edx
    165c:	6a 02                	push   $0x2
    165e:	68 cd 47 00 00       	push   $0x47cd
  ...
  if(unlink("unlinkread") != 0){
    ...
    1678:	68 cd 47 00 00       	push   $0x47cd
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
    ...
    1695:	68 cd 47 00 00       	push   $0x47cd
  ...
  write(fd1, "yyy", 3);
    16a4:	6a 03                	push   $0x3
    16a6:	68 2a 48 00 00       	push   $0x482a
    16ab:	50                   	push   %eax
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    16c1:	68 60 8b 00 00       	push   $0x8b60
    16c6:	53                   	push   %ebx
  ...
  if(buf[0] != 'h'){
    16d8:	80 3d 60 8b 00 00 68 	cmpb   $0x68,0x8b60
  ...
  if(write(fd, buf, 10) != 10){
    ...
    16e4:	6a 0a                	push   $0xa
    16e6:	68 60 8b 00 00       	push   $0x8b60
    16eb:	53                   	push   %ebx
  ...
  unlink("unlinkread");
    1702:	c7 04 24 cd 47 00 00 	movl   $0x47cd,(%esp)
    1709:	e8 b4 27 00 00       	call   3ec2 <unlink>
  printf(1, "unlinkread ok\n");
    170e:	58                   	pop    %eax
    170f:	5a                   	pop    %edx
    1710:	68 75 48 00 00       	push   $0x4875
    1715:	6a 01                	push   $0x1
    1717:	e8 a4 28 00 00       	call   3fc0 <printf>
}
  ...
  if(fd < 0){
    ...
    1726:	51                   	push   %ecx
    1727:	51                   	push   %ecx
    1728:	68 d8 47 00 00       	push   $0x47d8
    172d:	6a 01                	push   $0x1
    172f:	e8 8c 28 00 00       	call   3fc0 <printf>
    exit(0);
  ...
  if(write(fd, buf, 10) != 10){
    ...
    1740:	51                   	push   %ecx
    1741:	51                   	push   %ecx
    1742:	68 5c 48 00 00       	push   $0x485c
    1747:	6a 01                	push   $0x1
    1749:	e8 72 28 00 00       	call   3fc0 <printf>
    exit(0);
  ...
  if(buf[0] != 'h'){
    ...
    175a:	53                   	push   %ebx
    175b:	53                   	push   %ebx
    175c:	68 45 48 00 00       	push   $0x4845
    1761:	6a 01                	push   $0x1
    1763:	e8 58 28 00 00       	call   3fc0 <printf>
    exit(0);
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    1774:	56                   	push   %esi
    1775:	56                   	push   %esi
    1776:	68 2e 48 00 00       	push   $0x482e
    177b:	6a 01                	push   $0x1
    177d:	e8 3e 28 00 00       	call   3fc0 <printf>
    exit(0);
  ...
  if(unlink("unlinkread") != 0){
    ...
    178e:	50                   	push   %eax
    178f:	50                   	push   %eax
    1790:	68 10 48 00 00       	push   $0x4810
    1795:	6a 01                	push   $0x1
    1797:	e8 24 28 00 00       	call   3fc0 <printf>
    exit(0);
  ...
  if(fd < 0){
    ...
    17a8:	50                   	push   %eax
    17a9:	50                   	push   %eax
    17aa:	68 f8 47 00 00       	push   $0x47f8
    17af:	6a 01                	push   $0x1
    17b1:	e8 0a 28 00 00       	call   3fc0 <printf>
    exit(0);
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    17d7:	68 84 48 00 00       	push   $0x4884
    17dc:	6a 01                	push   $0x1
    17de:	e8 dd 27 00 00       	call   3fc0 <printf>

  unlink("lf1");
    17e3:	c7 04 24 8e 48 00 00 	movl   $0x488e,(%esp)
    17ea:	e8 d3 26 00 00       	call   3ec2 <unlink>
  unlink("lf2");
    17ef:	c7 04 24 92 48 00 00 	movl   $0x4892,(%esp)
  ...
  fd = open("lf1", O_CREATE|O_RDWR);
    ...
    1802:	68 8e 48 00 00       	push   $0x488e
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    181c:	6a 05                	push   $0x5
    181e:	68 f2 47 00 00       	push   $0x47f2
    1823:	50                   	push   %eax
  ...
  if(link("lf1", "lf2") < 0){
    183e:	5b                   	pop    %ebx
    183f:	58                   	pop    %eax
    1840:	68 92 48 00 00       	push   $0x4892
    1845:	68 8e 48 00 00       	push   $0x488e
  ...
  unlink("lf1");
    ...
    185d:	68 8e 48 00 00       	push   $0x488e
  ...
  if(open("lf1", 0) >= 0){
    ...
    1868:	5a                   	pop    %edx
    1869:	6a 00                	push   $0x0
    186b:	68 8e 48 00 00       	push   $0x488e
  ...
  fd = open("lf2", 0);
    ...
    1883:	6a 00                	push   $0x0
    1885:	68 92 48 00 00       	push   $0x4892
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    18a4:	68 60 8b 00 00       	push   $0x8b60
    18a9:	50                   	push   %eax
  ...
  if(link("lf2", "lf2") >= 0){
    18c4:	58                   	pop    %eax
    18c5:	5a                   	pop    %edx
    18c6:	68 92 48 00 00       	push   $0x4892
    18cb:	68 92 48 00 00       	push   $0x4892
  ...
  unlink("lf2");
    ...
    18e3:	68 92 48 00 00       	push   $0x4892
    18e8:	e8 d5 25 00 00       	call   3ec2 <unlink>
  if(link("lf2", "lf1") >= 0){
    18ed:	59                   	pop    %ecx
    18ee:	5b                   	pop    %ebx
    18ef:	68 8e 48 00 00       	push   $0x488e
    18f4:	68 92 48 00 00       	push   $0x4892
  ...
  if(link(".", "lf1") >= 0){
    ...
    1908:	68 8e 48 00 00       	push   $0x488e
    190d:	68 56 4b 00 00       	push   $0x4b56
  ...
  printf(1, "linktest ok\n");
    ...
    1921:	68 2c 49 00 00       	push   $0x492c
    1926:	6a 01                	push   $0x1
    1928:	e8 93 26 00 00       	call   3fc0 <printf>
}
  ...
  if(fd < 0){
    ...
    1935:	50                   	push   %eax
    1936:	50                   	push   %eax
    1937:	68 96 48 00 00       	push   $0x4896
    193c:	6a 01                	push   $0x1
    193e:	e8 7d 26 00 00       	call   3fc0 <printf>
    exit(0);
  ...
  if(link(".", "lf1") >= 0){
    ...
    194f:	50                   	push   %eax
    1950:	50                   	push   %eax
    1951:	68 10 49 00 00       	push   $0x4910
    1956:	6a 01                	push   $0x1
    1958:	e8 63 26 00 00       	call   3fc0 <printf>
    exit(0);
  ...
  if(link("lf2", "lf1") >= 0){
    ...
    1969:	52                   	push   %edx
    196a:	52                   	push   %edx
    196b:	68 c4 54 00 00       	push   $0x54c4
    1970:	6a 01                	push   $0x1
    1972:	e8 49 26 00 00       	call   3fc0 <printf>
    exit(0);
    1977:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    1983:	50                   	push   %eax
    1984:	50                   	push   %eax
    1985:	68 f2 48 00 00       	push   $0x48f2
    198a:	6a 01                	push   $0x1
    198c:	e8 2f 26 00 00       	call   3fc0 <printf>
    exit(0);
    1991:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    199d:	51                   	push   %ecx
    199e:	51                   	push   %ecx
    199f:	68 e1 48 00 00       	push   $0x48e1
    19a4:	6a 01                	push   $0x1
    19a6:	e8 15 26 00 00       	call   3fc0 <printf>
    exit(0);
  ...
  if(fd < 0){
    ...
    19b7:	53                   	push   %ebx
    19b8:	53                   	push   %ebx
    19b9:	68 d0 48 00 00       	push   $0x48d0
    19be:	6a 01                	push   $0x1
    19c0:	e8 fb 25 00 00       	call   3fc0 <printf>
    exit(0);
  ...
  if(open("lf1", 0) >= 0){
    ...
    19d1:	50                   	push   %eax
    19d2:	50                   	push   %eax
    19d3:	68 9c 54 00 00       	push   $0x549c
    19d8:	6a 01                	push   $0x1
    19da:	e8 e1 25 00 00       	call   3fc0 <printf>
    exit(0);
  ...
  if(link("lf1", "lf2") < 0){
    ...
    19eb:	51                   	push   %ecx
    19ec:	51                   	push   %ecx
    19ed:	68 bb 48 00 00       	push   $0x48bb
    19f2:	6a 01                	push   $0x1
    19f4:	e8 c7 25 00 00       	call   3fc0 <printf>
    exit(0);
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    1a05:	50                   	push   %eax
    1a06:	50                   	push   %eax
    1a07:	68 a9 48 00 00       	push   $0x48a9
    1a0c:	6a 01                	push   $0x1
    1a0e:	e8 ad 25 00 00       	call   3fc0 <printf>
    exit(0);
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    1a33:	68 39 49 00 00       	push   $0x4939
    1a38:	6a 01                	push   $0x1
    1a3a:	e8 81 25 00 00       	call   3fc0 <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    1afa:	53                   	push   %ebx
    1afb:	68 4c 49 00 00       	push   $0x494c
    1b00:	6a 01                	push   $0x1
    1b02:	e8 b9 24 00 00       	call   3fc0 <printf>
        exit(0);
    ...
    1b1b:	53                   	push   %ebx
    1b1c:	68 49 49 00 00       	push   $0x4949
  ...
  for(i = 0; i < 40; i++){
    ...
    1b3b:	53                   	push   %ebx
    1b3c:	68 49 49 00 00       	push   $0x4949
  ...
  fd = open(".", 0);
    ...
    1b64:	5e                   	pop    %esi
    1b65:	6a 00                	push   $0x0
    1b67:	68 56 4b 00 00       	push   $0x4b56
  ...
  printf(1, "concreate ok\n");
    ...
    1ccb:	68 9e 49 00 00       	push   $0x499e
    1cd0:	6a 01                	push   $0x1
    1cd2:	e8 e9 22 00 00       	call   3fc0 <printf>
}
  ...
  for(i = 0; i < 40; i++){
    ...
    1ce2:	68 21 52 00 00       	push   $0x5221
    1ce7:	6a 01                	push   $0x1
    1ce9:	e8 d2 22 00 00       	call   3fc0 <printf>
      exit(0);
  ...
  if(n != 40){
    ...
    1cfd:	68 e8 54 00 00       	push   $0x54e8
    1d02:	6a 01                	push   $0x1
    1d04:	e8 b7 22 00 00       	call   3fc0 <printf>
    exit(0);
    ...
    1d1b:	50                   	push   %eax
    1d1c:	68 81 49 00 00       	push   $0x4981
    1d21:	6a 01                	push   $0x1
    1d23:	e8 98 22 00 00       	call   3fc0 <printf>
        exit(0);
    ...
    1d3a:	50                   	push   %eax
    1d3b:	68 68 49 00 00       	push   $0x4968
    1d40:	6a 01                	push   $0x1
    1d42:	e8 79 22 00 00       	call   3fc0 <printf>
        exit(0);
...
linkunlink()
{
  ...
  printf(1, "linkunlink ok\n");
    1e2a:	58                   	pop    %eax
    1e2b:	5a                   	pop    %edx
    1e2c:	68 c1 49 00 00       	push   $0x49c1
    1e31:	6a 01                	push   $0x1
    1e33:	e8 88 21 00 00       	call   3fc0 <printf>
}
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    312a:	68 90 50 00 00       	push   $0x5090
    312f:	6a 01                	push   $0x1
    3131:	e8 8a 0e 00 00       	call   3fc0 <printf>
  ...
  printf(1, "fork test OK\n");
    ...
    3189:	68 c2 50 00 00       	push   $0x50c2
    318e:	6a 01                	push   $0x1
    3190:	e8 2b 0e 00 00       	call   3fc0 <printf>
}
...
sbrktest(void)
{
  ...
  // can one sbrk() less than a page?
  a = sbrk(0);
    3231:	e8 c4 0c 00 00       	call   3efa <sbrk>
  ...
  for(i = 0; i < 5000; i++){
    ...
    3243:	6a 01                	push   $0x1
    3245:	e8 b0 0c 00 00       	call   3efa <sbrk>
    if(b != a){
  ...
  c = sbrk(1);
    327b:	6a 01                	push   $0x1
    327d:	e8 78 0c 00 00       	call   3efa <sbrk>
  c = sbrk(1);
    3282:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    3289:	e8 6c 0c 00 00       	call   3efa <sbrk>
  if(c != a + 1){
...
#define BIG (100*1024*1024)
  a = sbrk(0);
    ...
    32b4:	e8 41 0c 00 00       	call   3efa <sbrk>
  ...
  p = sbrk(amt);
    ...
    32c5:	e8 30 0c 00 00       	call   3efa <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    32df:	6a 00                	push   $0x0
    32e1:	e8 14 0c 00 00       	call   3efa <sbrk>
  c = sbrk(-4096);
  ...
  *lastaddr = 99;
  ...
  c = sbrk(-4096);
    32ef:	e8 06 0c 00 00       	call   3efa <sbrk>
  ...
  c = sbrk(0);
    ...
    3303:	6a 00                	push   $0x0
    3305:	e8 f0 0b 00 00       	call   3efa <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    331e:	6a 00                	push   $0x0
    3320:	e8 d5 0b 00 00       	call   3efa <sbrk>
    3325:	89 c6                	mov    %eax,%esi
  c = sbrk(4096);
    3327:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
    332e:	e8 c7 0b 00 00       	call   3efa <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    3343:	6a 00                	push   $0x0
    3345:	e8 b0 0b 00 00       	call   3efa <sbrk>
  ...
  a = sbrk(0);
    ...
    336b:	6a 00                	push   $0x0
    336d:	e8 88 0b 00 00       	call   3efa <sbrk>
  ...
  c = sbrk(4096);
    ...
    342a:	e8 cb 0a 00 00       	call   3efa <sbrk>
  ...
  if(sbrk(0) > oldbrk)
    ...
    3465:	6a 00                	push   $0x0
    3467:	e8 8e 0a 00 00       	call   3efa <sbrk>
    ...
    3477:	6a 00                	push   $0x0
    3479:	e8 7c 0a 00 00       	call   3efa <sbrk>
    347e:	8b 4d a4             	mov    -0x5c(%ebp),%ecx
    3481:	29 c1                	sub    %eax,%ecx
    3483:	89 0c 24             	mov    %ecx,(%esp)
    3486:	e8 6f 0a 00 00       	call   3efa <sbrk>
    348b:	83 c4 10             	add    $0x10,%esp

  printf(stdout, "sbrk test OK\n");
    348e:	83 ec 08             	sub    $0x8,%esp
    3491:	68 78 51 00 00       	push   $0x5178
    3496:	ff 35 84 63 00 00    	pushl  0x6384
    349c:	e8 1f 0b 00 00       	call   3fc0 <printf>
}
  ...
  for(i = 0; i < sizeof(pids)/sizeof(pids[0]); i++){
    ...
    34e8:	e8 15 0a 00 00       	call   3f02 <sleep>
  ...
  for(i = 0; i < 5000; i++){
    ...
    34fd:	ff 35 84 63 00 00    	pushl  0x6384
  ...
  if(c == (char*)0xffffffff){
    ...
    351a:	ff 35 84 63 00 00    	pushl  0x6384
  ...
  if(pipe(fds) != 0){
    ...
    3556:	ff 35 84 63 00 00    	pushl  0x6384
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    357d:	ff 35 84 63 00 00    	pushl  0x6384
  ...
  if(c != a){
    ...
    359b:	ff 35 84 63 00 00    	pushl  0x6384
  ...
  if(*lastaddr == 99){
    ...
    35ba:	ff 35 84 63 00 00    	pushl  0x6384
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    35d8:	ff 35 84 63 00 00    	pushl  0x6384
  ...
  if(c != a - 4096){
    ...
    35f6:	ff 35 84 63 00 00    	pushl  0x6384
  ...
  if(c == (char*)0xffffffff){
    ...
    3615:	ff 35 84 63 00 00    	pushl  0x6384
...
#define BIG (100*1024*1024)
  ...
  if (p != a) {
    ...
    3634:	ff 35 84 63 00 00    	pushl  0x6384
  ...
  if(c != a + 1){
    ...
    365d:	ff 35 84 63 00 00    	pushl  0x6384
  ...
  if(pid < 0){
    ...
    367c:	ff 35 84 63 00 00    	pushl  0x6384
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    36be:	68 86 51 00 00       	push   $0x5186
    36c3:	ff 35 84 63 00 00    	pushl  0x6384
    36c9:	e8 f2 08 00 00       	call   3fc0 <printf>
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    36e6:	6a 00                	push   $0x0
    36e8:	e8 15 08 00 00       	call   3f02 <sleep>
    sleep(0);
    36ed:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    36f4:	e8 09 08 00 00       	call   3f02 <sleep>
    kill(pid);
    ...
    370a:	5a                   	pop    %edx
    370b:	53                   	push   %ebx
    370c:	68 95 51 00 00       	push   $0x5195
  ...
  printf(stdout, "validate ok\n");
    ...
    372f:	68 b9 51 00 00       	push   $0x51b9
    3734:	ff 35 84 63 00 00    	pushl  0x6384
    373a:	e8 81 08 00 00       	call   3fc0 <printf>
}
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    3757:	68 a0 51 00 00       	push   $0x51a0
    375c:	ff 35 84 63 00 00    	pushl  0x6384
    3762:	e8 59 08 00 00       	call   3fc0 <printf>
      exit(0);
...
bsstest(void)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
    ...
    37e5:	e8 d6 07 00 00       	call   3fc0 <printf>
      exit(0);
    37ea:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
...
bigargtest(void)
{
  ...
  fd = open("bigarg-ok", 0);
    ...
    382f:	59                   	pop    %ecx
    3830:	6a 00                	push   $0x0
    3832:	68 ee 51 00 00       	push   $0x51ee
  ...
  unlink("bigarg-ok");
    3850:	c7 04 24 ee 51 00 00 	movl   $0x51ee,(%esp)
    3857:	e8 66 06 00 00       	call   3ec2 <unlink>
}
    385c:	83 c4 10             	add    $0x10,%esp
    385f:	c9                   	leave  
    3860:	c3                   	ret    
    3861:	b8 a0 63 00 00       	mov    $0x63a0,%eax
  ...
  if(pid == 0){
    ...
    3870:	c7 00 48 59 00 00    	movl   $0x5948,(%eax)
  ...
  if(pid == 0){
    ...
    int i;
    for(i = 0; i < MAXARG-1; i++)
    3879:	3d 1c 64 00 00       	cmp    $0x641c,%eax
    ...
    3880:	50                   	push   %eax
    3881:	50                   	push   %eax
    3882:	68 f8 51 00 00       	push   $0x51f8
    3887:	ff 35 84 63 00 00    	pushl  0x6384
  if(pid == 0){
    static char *args[MAXARG];
    int i;
    for(i = 0; i < MAXARG-1; i++)
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    388d:	c7 05 1c 64 00 00 00 	movl   $0x0,0x641c
    3894:	00 00 00 
    printf(stdout, "bigarg test\n");
    3897:	e8 24 07 00 00       	call   3fc0 <printf>
    exec("echo", args);
    389c:	58                   	pop    %eax
    389d:	5a                   	pop    %edx
    389e:	68 a0 63 00 00       	push   $0x63a0
    38a3:	68 c5 43 00 00       	push   $0x43c5
    38a8:	e8 fd 05 00 00       	call   3eaa <exec>
    printf(stdout, "bigarg test ok\n");
    38ad:	59                   	pop    %ecx
    38ae:	58                   	pop    %eax
    38af:	68 05 52 00 00       	push   $0x5205
    38b4:	ff 35 84 63 00 00    	pushl  0x6384
    38ba:	e8 01 07 00 00       	call   3fc0 <printf>
    fd = open("bigarg-ok", O_CREATE);
    38bf:	58                   	pop    %eax
    38c0:	5a                   	pop    %edx
    38c1:	68 00 02 00 00       	push   $0x200
    38c6:	68 ee 51 00 00       	push   $0x51ee
  ...
  if(fd < 0){
    ...
    38e4:	50                   	push   %eax
    38e5:	50                   	push   %eax
    38e6:	68 2e 52 00 00       	push   $0x522e
    38eb:	ff 35 84 63 00 00    	pushl  0x6384
    38f1:	e8 ca 06 00 00       	call   3fc0 <printf>
    exit(0);
    ...
    3902:	50                   	push   %eax
    3903:	50                   	push   %eax
    3904:	68 15 52 00 00       	push   $0x5215
    3909:	ff 35 84 63 00 00    	pushl  0x6384
    390f:	e8 ac 06 00 00       	call   3fc0 <printf>
    exit(0);
    3914:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
...
uio()
{
  ...
  printf(1, "uio test done\n");
    3b3c:	58                   	pop    %eax
    3b3d:	5a                   	pop    %edx
    3b3e:	68 9c 52 00 00       	push   $0x529c
    3b43:	6a 01                	push   $0x1
    3b45:	e8 76 04 00 00       	call   3fc0 <printf>
}
  ...
  if(pid == 0){
    ...
    3b60:	50                   	push   %eax
    3b61:	50                   	push   %eax
    3b62:	68 28 5a 00 00       	push   $0x5a28
    3b67:	6a 01                	push   $0x1
    3b69:	e8 52 04 00 00       	call   3fc0 <printf>
    exit(0);
    3b6e:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3b75:	e8 f8 02 00 00       	call   3e72 <exit>
  } else if(pid < 0){
    printf (1, "fork failed\n");
    3b7a:	51                   	push   %ecx
    3b7b:	51                   	push   %ecx
    3b7c:	68 21 52 00 00       	push   $0x5221
    3b81:	6a 01                	push   $0x1
    3b83:	e8 38 04 00 00       	call   3fc0 <printf>
    exit(0);
    3b88:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
...
void argptest()
{
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    3bbf:	6a 00                	push   $0x0
    3bc1:	e8 34 03 00 00       	call   3efa <sbrk>
...
void argptest()
{
  ...
  if (fd < 0) {
    ...
    exit(0);
    3c01:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    3f98:	e8 f5 fe ff ff       	call   3e92 <write>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    4008:	50                   	push   %eax
    4009:	57                   	push   %edi
    400a:	e8 83 fe ff ff       	call   3e92 <write>
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    406a:	50                   	push   %eax
    406b:	57                   	push   %edi
    406c:	e8 21 fe ff ff       	call   3e92 <write>
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    40fe:	50                   	push   %eax
    40ff:	57                   	push   %edi
    4100:	e8 8d fd ff ff       	call   3e92 <write>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
...
putc(int fd, char c)
{
  write(fd, &c, 1);
    ...
    414f:	50                   	push   %eax
    4150:	57                   	push   %edi
    4151:	e8 3c fd ff ff       	call   3e92 <write>
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    425e:	53                   	push   %ebx
    425f:	e8 96 fc ff ff       	call   3efa <sbrk>
  if(p == (char*)-1)
