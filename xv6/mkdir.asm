...
main(int argc, char *argv[])
{
  ...
  75:	52                   	push   %edx
  76:	52                   	push   %edx
  77:	68 50 07 00 00       	push   $0x750
  7c:	6a 02                	push   $0x2
  7e:	e8 ad 03 00 00       	call   430 <printf>
    exit(0);
...
free(void *ap)
{
 ...
 627:	89 08                	mov    %ecx,(%eax)
  freep = p;
 629:	a3 48 0a 00 00       	mov    %eax,0xa48
}
 62e:	5b                   	pop    %ebx
 62f:	5e                   	pop    %esi
 630:	5f                   	pop    %edi
 ...
 64a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 64d:	a3 48 0a 00 00       	mov    %eax,0xa48
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 15 48 0a 00 00    	mov    0xa48,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 70c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 70f:	89 15 48 0a 00 00    	mov    %edx,0xa48
      return (void*)(p + 1);
 ...
 724:	eb e9                	jmp    70f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 726:	c7 05 48 0a 00 00 4c 	movl   $0xa4c,0xa48
 72d:	0a 00 00 
 730:	c7 05 4c 0a 00 00 4c 	movl   $0xa4c,0xa4c
 737:	0a 00 00 
    base.s.size = 0;
 73a:	b8 4c 0a 00 00       	mov    $0xa4c,%eax
 73f:	c7 05 50 0a 00 00 00 	movl   $0x0,0xa50
 746:	00 00 00 
